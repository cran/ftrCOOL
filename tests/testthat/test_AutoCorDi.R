context("Just testing AutoCorDiNuc functionality")

test_that("Check whether length of Moran vector is correct",{
  moranCor<-AutoCorDiNuc(seqs="AGCCCCGT",selectedNucIdx = 1:10,maxlag = 4,type = "Moran",threshold = 1)
...
test_that("Check whether length of Geary vector is correct",{
  gearyCor<-AutoCorDiNuc(seqs="AGCCCCGT",selectedNucIdx = 1:10,maxlag = 4,type = "Geary",threshold = 1)
...
test_that("Check whether length of NormalizeMBorto vector is correct",{
  norBorCor<-AutoCorDiNuc(seqs="AGCCCCGT",selectedNucIdx = 1:10,maxlag = 4,type = "NormalizeMBorto",threshold = 1)
...
test_that("Check whether length of AC vector is correct",{
  ACcov<-AutoCorDiNuc(seqs="AGCCCCGT",selectedNucIdx = 1:10,maxlag = 4,type = "AC",threshold = 1)
  lenAC<-length(ACcov)
  expected_len<-10*4
...
test_that("Check whether length of CC vector is correct",{
  CCcov<-AutoCorDiNuc(seqs="AGCCCCGT",selectedNucIdx = 1:10,maxlag = 4,type = "CC",threshold = 1)
  lenCC<-length(CCcov)
...
test_that("Check whether length of ACC vector is correct",{
  ACCcov<-AutoCorDiNuc(seqs="AGCCCCGT",selectedNucIdx = 1:10,maxlag = 4,type = "ACC",threshold = 1)
