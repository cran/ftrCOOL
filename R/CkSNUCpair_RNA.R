...
#'
#' @param rng This parameter can be a number or a vector. Each element of the vector shows the number of spaces between ribonucleotide pairs.
...
CkSNUCpair_RNA <- function(seqs,rng=3,upto=FALSE,ORF=FALSE,reverseORF=TRUE,normalized=TRUE,label=c()){
  ...
  tempname<-nameKmer(k=2,type = "rna")
