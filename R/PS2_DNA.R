...
#'
#' This function transforms each di-nucleotide of the sequence to a binary format.
...
PS2_DNA<- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  dict=1:16
  names(dict)=nameKmer(k=2,type="dna")
