...
Zcurve144bit_DNA<-function(seqs,ORF=FALSE,reverseORF=TRUE,label=c()){
  ...
  for(n in 1:numSeqs){
    ...
    freqTrimPos3[names(TrimPos3)]<-TrimPos3
      ...
      Pxt=freqTrimPos1[paste(DiNuc,"T",sep="")]
      ...
      Pxt2=freqTrimPos2[paste(DiNuc,"T",sep="")]
      ...
      Pxt3=freqTrimPos3[paste(DiNuc,"T",sep="")]
