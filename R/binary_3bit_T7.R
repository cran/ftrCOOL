...
binary_3bit_T7 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("Buried"=c("A","L","F","C","G","I","V","W"),"Exposed"=c("R","K","Q","E","N","D"),"Intermediate"=c("M","S","P","T","H","Y"))
  grps<-unlist(Group)
