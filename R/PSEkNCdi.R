#' Pseudo k Nucleotide Composition-Di(Parallel)
#'
#' This function calculates the pseudo-k nucleotide composition(Di) (Parallel)
#' for each sequence.
#'
...
#' Users can choose the desired indices by their ids or their names in the dinucleotide peoperties file.
#'
...
#'
#' @param threshold is a number between (0 , 1]. In selectedNucIdx, indices with a correlation
...
PSEkNCdi<-function(seqs,selectedNucIdx,lambda=3,w = 0.05,l=2,ORF=FALSE,reverseORF=TRUE,threshold=1,label=c()){
