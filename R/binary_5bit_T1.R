...
binary_5bit_T1 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("Grp1"=c("G","A","V","L","M","I"),"Grp2"=c("F","Y","W"),"Grp3"=c("K","R","H"),"Grp4"=c("D","E"),"Grp5"=c("S","T","C","P","N","Q"))
  grps<-unlist(Group)
