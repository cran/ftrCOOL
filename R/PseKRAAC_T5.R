#' Pseudo K_tuple Reduced Amino Acid Composition(PseKRAAComposition Type_5)
#'
...
#' PseKRAAC_type5(PseKRAAC_T5) contains Grp 3,4,8,10,15,20.
#'
#'
...
#'
#' @details Groups:
#' 3=c('FWYCILMVAGSTPHNQ', 'DE', 'KR'),
#' 4=c('FWY', 'CILMV', 'AGSTP', 'EQNDHKR'),
#' 8=c('FWY', 'CILMV', 'GA', 'ST', 'P', 'EQND', 'H', 'KR'),
#' 10=c('G', 'FYW', 'A', 'ILMV', 'RK', 'P', 'EQND', 'H', 'ST', 'C'),
#' 15=c('G', 'FY', 'W', 'A', 'ILMV', 'E', 'Q', 'RK', 'P', 'N', 'D', 'H', 'S', 'T', 'C'),
...
PseKRAAC_T5 <- function(seqs,type="gap",Grp=4,GapOrLambdaValue=2,k=4,label=c())
{
  ...
  AAGroup = list(
    Grp3=c('FWYCILMVAGSTPHNQ', 'DE', 'KR'),
    Grp4=c('FWY', 'CILMV', 'AGSTP', 'EQNDHKR'),
    Grp8=c('FWY', 'CILMV', 'GA', 'ST', 'P', 'EQND', 'H', 'KR'),
    Grp10=c('G', 'FYW', 'A', 'ILMV', 'RK', 'P', 'EQND', 'H', 'ST', 'C'),
    Grp15=c('G', 'FY', 'W', 'A', 'ILMV', 'E', 'Q', 'RK', 'P', 'N', 'D', 'H', 'S', 'T', 'C'),
