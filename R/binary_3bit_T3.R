...
binary_3bit_T3 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("4.9-6.2"=c("L","I","F","W","C","M","V","Y"),"8.0-9.2"=c("P","A","T","G","S"),"10.4-13.0"=c("H","Q","R","K","N","E","D"))
  grps<-unlist(Group)
