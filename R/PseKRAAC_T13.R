#' Pseudo K_tuple Reduced Amino Acid Composition(PseKRAAComposition Type_13)
#'
...
#' PseKRAAC_type13(PseKRAAC_T13) contains Grp 4,12,17,20.
#'
#'
...
#'
#' @details Groups:
#' 4=c('ADKERNTSQ', 'YFLIVMCWH', 'G', 'P'),
#' 12=c('A', 'D', 'KER', 'N', 'TSQ', 'YF', 'LIVM', 'C', 'W', 'H', 'G', 'P'),
#' 17=c('A', 'D', 'KE', 'R', 'N', 'T', 'S', 'Q', 'Y', 'F', 'LIV', 'M', 'C', 'W', 'H', 'G', 'P'),
#' 20=c('A', 'D', 'K', 'E', 'R', 'N', 'T', 'S', 'Q', 'Y', 'F', 'L', 'I', 'V', 'M', 'C', 'W', 'H', 'G', 'P')
#'
#' @export
#'
#' @examples
...
PseKRAAC_T13 <- function(seqs,type="gap",Grp=4,GapOrLambdaValue=2,k=4,label=c())
{
  ...
  AAGroup = list(
    Grp4=c('ADKERNTSQ', 'YFLIVMCWH', 'G', 'P'),
    Grp12=c('A', 'D', 'KER', 'N', 'TSQ', 'YF', 'LIVM', 'C', 'W', 'H', 'G', 'P'),
    Grp17=c('A', 'D', 'KE', 'R', 'N', 'T', 'S', 'Q', 'Y', 'F', 'LIV', 'M', 'C', 'W', 'H', 'G', 'P'),
    Grp20=c('A', 'D', 'K', 'E', 'R', 'N', 'T', 'S', 'Q', 'Y', 'F', 'L', 'I', 'V', 'M', 'C', 'W', 'H', 'G', 'P')
  )
