...
binary_3bit_T4 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("0-0.108"=c("G","A","S","D","T"),"0.128-0.186"=c("C","P","N","V","E","Q","I","L"),"0.219-0.409"=c("K","M","H","F","R","Y","W"))
  grps<-unlist(Group)
