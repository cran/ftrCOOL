...
#'
#' @param standardized is a logical parameter. If it is set to TRUE, all the indices will be in their standard format.
...
TriNucIndex <- function(seqs,selectedNucIdx=1:12,standardized=TRUE,threshold=0.8,label=c(),outFormat="mat",outputFileDist="")
{
