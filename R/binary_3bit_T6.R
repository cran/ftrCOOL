...
binary_3bit_T6 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("Helix"=c("E","A","L","M","Q","K","R","H"),"Strand"=c("V","I","Y","C","W","F","T"),"Coil"=c("G","N","P","S","D"))
  grps<-unlist(Group)
