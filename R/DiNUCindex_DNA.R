...
#'
#' @param selectedIdx DiNUCindex_DNA function works based on physicochemical properties. Users, select the properties by their ids
...
DiNUCindex_DNA <- function(seqs,selectedIdx=c("Rise", "Roll", "Shift", "Slide", "Tilt", "Twist"),threshold=1,label=c(),outFormat="mat",outputFileDist="")
{
