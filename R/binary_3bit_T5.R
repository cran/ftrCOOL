...
binary_3bit_T5 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("Positive"=c("K","R"),"Neutral"=c("A","N","C","Q","G","H","I","L","M","F","P","S","T","W","Y","V"),"Negative"=c("D","E"))
  grps<-unlist(Group)
