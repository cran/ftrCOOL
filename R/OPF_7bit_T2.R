...
#' This function includes 7 amino acid properties. OPF_7bit_T2 substitutes each amino acid with a 7-dimensional vector.
...
#'
OPF_7bit_T2<-function(seqs,label=c(),outFormat="mat",outputFileDist=""){
  ...
  group<-list("Hydrophobicity"= c('D','E'),
              "Normalized Vander Waals volume"= c('A','G', 'H','P','S','T','Y'),
              "Polarity"=   c('E', 'I', 'L', 'N', 'Q', 'V'),
              "Polarizibility"=  c('A', 'G', 'P', 'S', 'T'),
              "Charge"= c('C', 'E', 'I', 'L', 'N', 'P', 'Q', 'V'),
              "Secondary structures"= c('A', 'E', 'H', 'K', 'L', 'M', 'Q', 'R'),
              "Solvent accessibility"=   c('H', 'M', 'P', 'S', 'T', 'Y'))
