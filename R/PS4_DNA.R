...
#'
#' This function transforms each 4-nucleotide of the sequence to a binary format.
...
#' 'strBin'(String binary): each di-nucleotide is represented by a string containing 256 characters (255 times '0' and one '1'). For example, 'AAA' = "1000000000000000...0", ....
...
PS4_DNA<- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  dict=1:256
  names(dict)=nameKmer(k=4,type="dna")
