#' Pseudo K_tuple Reduced Amino Acid Composition(PseKRAAComposition Type_2)
#'
...
#' PseKRAAC_type2(PseKRAAC_T2) contains Grp 2-6,8,15,20.
#'
#'
...
#' @details Groups:
#'
#' 2=c('LVIMCAGSTPFYW', 'EDNQKRH'),
#' 3=c('LVIMCAGSTP', 'FYW', 'EDNQKRH'),
#' 4=c('LVIMC', 'AGSTP', 'FYW', 'EDNQKRH'),
#' 5=c('LVIMC', 'AGSTP', 'FYW', 'EDNQ', 'KRH'),
#' 6=c('LVIM', 'AGST', 'PHC', 'FYW', 'EDNQ', 'KR'),
#' 8=c('LVIMC', 'AG', 'ST', 'P', 'FYW', 'EDNQ', 'KR', 'H'),
#' 15=c('LVIM', 'C', 'A', 'G', 'S', 'T', 'P', 'FY', 'W', 'E', 'D', 'N', 'Q', 'KR', 'H'),
#' 20=c('L', 'V', 'I', 'M', 'C', 'A', 'G', 'S', 'T', 'P', 'F', 'Y', 'W', 'E', 'D', 'N', 'Q', 'K', 'R', 'H')
#'
#'
#' @export
#'
...
PseKRAAC_T2 <- function(seqs,type="gap",Grp=2,GapOrLambdaValue=2,k=4,label=c())
{
  ...
  AAGroup = list(
    Grp2=c('LVIMCAGSTPFYW', 'EDNQKRH'),
    Grp3=c('LVIMCAGSTP', 'FYW', 'EDNQKRH'),
    Grp4=c('LVIMC', 'AGSTP', 'FYW', 'EDNQKRH'),
    Grp5=c('LVIMC', 'AGSTP', 'FYW', 'EDNQ', 'KRH'),
    Grp6=c('LVIM', 'AGST', 'PHC', 'FYW', 'EDNQ', 'KR'),
    Grp8=c('LVIMC', 'AG', 'ST', 'P', 'FYW', 'EDNQ', 'KR', 'H'),
    Grp15=c('LVIM', 'C', 'A', 'G', 'S', 'T', 'P', 'FY', 'W', 'E', 'D', 'N', 'Q', 'KR', 'H'),
    Grp20=c('L', 'V', 'I', 'M', 'C', 'A', 'G', 'S', 'T', 'P', 'F', 'Y', 'W', 'E', 'D', 'N', 'Q', 'K', 'R', 'H')
  )
