...
#'
#' @param pos is a fasta file containing ribonucleotide sequences. Each sequence starts
#' with '>'. Also, the value of this parameter can be a string vector.
#' The sequences are positive sequences in the training model
#'
#' @param neg is a fasta file containing ribonucleotide sequences. Each sequence starts
#' with '>'. Also, the value of this parameter can be a string vector.
#'
