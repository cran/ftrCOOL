...
#' Users can choose the desired indices by their ids or their names in the DI_DNA index file.
...
APkNUCdi_DNA<-function(seqs,selectedIdx=c("Rise", "Roll", "Shift", "Slide", "Tilt", "Twist"),lambda=3,w = 0.05,l=2,ORF=FALSE,reverseORF=TRUE,threshold=1,label=c())
{
