#' Pseudo K_tuple Reduced Amino Acid Composition(PseKRAAComposition Type_6A)
#'
...
#' PseKRAAC_type6 contain two type: type6A and type6B. 'PseKRAAC_T6A' contains Grp 4,5,20.
#'
#'
...
#'
#' @details Groups:
#' 4=c('AGPST', 'CILMV', 'DEHKNQR', 'FYW'),
#' 5=c('AHT', 'CFILMVWY', 'DE', 'GP', 'KNQRS'),
#' 20=c('A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'Y')
#'
#' @export
#'
#' @examples
...
PseKRAAC_T6A <- function(seqs,type="gap",Grp=5,GapOrLambdaValue=2,k=4,label=c())
{
  ...
  AAGroup = list(
    Grp4=c('AGPST', 'CILMV', 'DEHKNQR', 'FYW'),
    Grp5=c('AHT', 'CFILMVWY', 'DE', 'GP', 'KNQRS'),
    Grp20=c('A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'Y')
  )
