...
binary_3bit_T1 <- function(seqs,binaryType="numBin",label=c(),outFormat="mat",outputFileDist="")
{
  ...
  Group=list("Plar"=c("R","K","E","D","Q","N"),"Neutral"=c("G","A","S","T","P","H","Y"),"Hydrophobicity"=c("C","L","V","I","M","F","W"))
  grps<-unlist(Group)
