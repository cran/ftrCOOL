#' Pseudo K_tuple Reduced Amino Acid Composition(PseKRAAComposition Type_4)
#'
...
#' PseKRAAC_type4(PseKRAAC_T4) contains Grp 5,8,9,11,13,20.
#'
#'
...
#'
#' @details Groups:
#' 5=c('G', 'IVFYW', 'ALMEQRK', 'P', 'NDHSTC'),
#' 8=c('G', 'IV', 'FYW', 'ALM', 'EQRK', 'P', 'ND', 'HSTC'),
#' 9=c('G', 'IV', 'FYW', 'ALM', 'EQRK', 'P', 'ND', 'HS', 'TC'),
#' 11=c('G', 'IV', 'FYW', 'A', 'LM', 'EQRK', 'P', 'ND', 'HS', 'T', 'C'),
#' 13=c('G', 'IV', 'FYW', 'A', 'L', 'M', 'E', 'QRK', 'P', 'ND', 'HS', 'T', 'C'),
#' 20=c('G', 'I', 'V', 'F', 'Y', 'W', 'A', 'L', 'M', 'E', 'Q', 'R', 'K', 'P', 'N', 'D', 'H', 'S', 'T', 'C')
#'
#' @export
#'
#' @examples
...
PseKRAAC_T4 <- function(seqs,type="gap",Grp=5,GapOrLambdaValue=2,k=4,label=c())
{
  ...
  AAGroup = list(
    Grp5=c('G', 'IVFYW', 'ALMEQRK', 'P', 'NDHSTC'),
    Grp8=c('G', 'IV', 'FYW', 'ALM', 'EQRK', 'P', 'ND', 'HSTC'),
    Grp9=c('G', 'IV', 'FYW', 'ALM', 'EQRK', 'P', 'ND', 'HS', 'TC'),
    Grp11=c('G', 'IV', 'FYW', 'A', 'LM', 'EQRK', 'P', 'ND', 'HS', 'T', 'C'),
    Grp13=c('G', 'IV', 'FYW', 'A', 'L', 'M', 'E', 'QRK', 'P', 'ND', 'HS', 'T', 'C'),
    Grp20=c('G', 'I', 'V', 'F', 'Y', 'W', 'A', 'L', 'M', 'E', 'Q', 'R', 'K', 'P', 'N', 'D', 'H', 'S', 'T', 'C')
  )
